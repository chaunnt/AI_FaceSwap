...
def start() -> None:
    ...
    if has_image_extension(modules.globals.target_path):
        ...
        if is_image(modules.globals.target_path):
            ...
            update_status('Xử lý hình ảnh thất bại!')
        return
    ...
    update_status("Đang trích xuất khung hình")
    ...
    if modules.globals.keep_fps:
        ...
        update_status("Đang phát hiện FPS")
        ...
        update_status(f"Đang tạo video với 30.0 fps...")
    ...
    if modules.globals.keep_audio:
        if modules.globals.keep_fps:
            ...
            update_status("Việc khôi phục âm thanh có thể gây ra vấn đề vì không duy trì được fps...")
